...
export default function Profile({ author, social, features, researchInterests }: ProfileProps) {
    ...
    useEffect(() => {
        ...
        const userHasLiked = localStorage.getItem('xin-guo-website-user-liked');
    ...
    const handleLike = () => {
        ...
        if (newLikedState) {
            localStorage.setItem('xin-guo-website-user-liked', 'true');
            setShowThanks(true);
            setTimeout(() => setShowThanks(false), 2000);
        } else {
            localStorage.removeItem('xin-guo-website-user-liked');
            setShowThanks(false);
        }
    };
    ...
    return (
        ...
        >
            ...
            <div className="text-center mb-6">
                ...
                <p className="text-neutral-600 mb-2 whitespace-pre-line">
                    {author.institution}
                </p>
            </div>
